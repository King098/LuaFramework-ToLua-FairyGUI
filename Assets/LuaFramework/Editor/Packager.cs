...
public class Packager {
    ...
    static void HandleExampleBundle() {
        ...
        #if FairyGUI
        AddBuildMap("testui_des" + AppConst.ExtName,"*.bytes","Assets/LuaFramework/Examples/Builds/FairyGUI/Des/TestUI");
        AddBuildMap("testui_res" + AppConst.ExtName,"*.bytes|*.png","Assets/LuaFramework/Examples/Builds/FairyGUI/Res/TestUI");
        #endif
    }
