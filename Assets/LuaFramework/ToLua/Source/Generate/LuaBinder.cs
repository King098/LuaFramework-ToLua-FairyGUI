...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		FairyUIWrap.Register(L);
		FairyUIManagerWrap.Register(L);
		FairyRootWrap.Register(L);
		FairyUIModeWrap.Register(L);
		FairyUIStateWrap.Register(L);
		FairyUITypeWrap.Register(L);
		ViewWrap.Register(L);
		BaseWrap.Register(L);
		...
		L.RegFunction("Action_FairyGUI_GObject", System_Action_FairyGUI_GObject);
		L.BeginModule("Collections");
		L.BeginModule("Generic");
		System_Collections_Generic_Stack_FairyGUI_GComponentWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.EndModule();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_FairyGUI_GObject(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<FairyGUI.GObject>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<FairyGUI.GObject>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
